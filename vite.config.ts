  ...
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        ...
        updateURL:
          'https://github.com/andywang425/BLTH/releases/latest/download/bilibili-live-tasks-helper.meta.js',
        downloadURL:
          'https://github.com/andywang425/BLTH/releases/latest/download/bilibili-live-tasks-helper.min.user.js',
        ...
        license: 'MIT',
        match: [
          '*://live.bilibili.com/22474988',
          '*://live.bilibili.com/blanc/22474988',
        ],
